...
const Icon = ({ name }: { name: string }) => {
  ...
  const iconPaths: { [key: string]: React.ReactNode } = {
    ...
    default: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.79 4 4s-1.79 4-4 4-4-1.79-4-4c0-1.105.448-2.105 1.172-2.828L8.228 9z" />
  };
