    ...
    <header className="body-font">
      <div className="flex items-center p-5 px-[41px]">
        ...
        <nav className="flex items-center justify-center gap-x-[45px] text-[16px]"> 
          <Link href="/" className="text-[#AAAAAA] hover:text-white [font-family:var(--font-manrope)]">
            Głowna
          </Link>
          <Link href="/second" className={`${pathname === "/second" ? "text-white" : "text-[#AAAAAA]"} hover:text-white [font-family:var(--font-manrope)]`}>
            O nas
          </Link>
          <Link href="/third" className={`${pathname === "/third" ? "text-white" : "text-[#AAAAAA]"} hover:text-white [font-family:var(--font-manrope)]`}>
            Karnet
          </Link>
          <Link href="/zajecia" className={`${pathname === "/zajecia" ? "text-white" : "text-[#AAAAAA]"} hover:text-white [font-family:var(--font-manrope)]`}>
            Zajęcia
          </Link>
        </nav>
